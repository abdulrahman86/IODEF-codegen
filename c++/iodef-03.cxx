...
namespace iodef_1_0
{
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // IODEF_Document
      //
      if (n.name () == "IODEF_Document" && n.namespace_ () == "urn:ietf:params:xml:ns:iodef-1.0")
      {
         ...
         ::xml_schema::flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_purpose" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_role" && n.namespace_ ().empty ())
      {
      ...
      if (n.name () == "ext_type" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_metric" && n.namespace_ ().empty ())
      {
      ...
      if (n.name () == "ext_duration" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_dtype" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_registry" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_action" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_category" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "ext_offsetunit" && n.namespace_ ().empty ())
      {
         ...
         ::xml_schema::flags f)
  {
    while (p.more_attributes ())
    {
      ...
      if (n.name () == "vlan_name" && n.namespace_ ().empty ())
      {
      ...
      if (n.name () == "vlan_num" && n.namespace_ ().empty ())
      {
