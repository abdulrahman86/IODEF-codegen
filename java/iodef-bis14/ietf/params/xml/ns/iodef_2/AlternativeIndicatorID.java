 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:ietf:params:xml:ns:iodef-2.0}IndicatorID" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "AlternativeIndicatorID")
public class AlternativeIndicatorID {

    @XmlElement(name = "IndicatorID", required = true)
    protected List<IndicatorID> indicatorID;
     ...
     * This is why there is not a <CODE>set</CODE> method for the indicatorID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIndicatorID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IndicatorID> getIndicatorID() {
        if (indicatorID == null) {
            indicatorID = new ArrayList<IndicatorID>();
        }
